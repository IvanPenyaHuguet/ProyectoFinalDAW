...
import com.proyectofinal.daw.repositories.OrganicReagentRepository;
...
public class OrganicReagentService extends ReagentService{
    ...
    @Autowired
    GenericSearchImpl<OrganicReagent> genericSearch;

    @Override
    public Page<OrganicReagent> getAllPage(Pageable pageable) {
    ...
    public Map <String, Object> reagentsByLocationId (Map<String, Object> params) throws ResponseStatusException {
        ...
        if ( Objects.isNull(params.get("location")) ) {
            ...
            Page<OrganicReagent> pageReagent = reagentRepo.findByLocationId(location, pageRequest);
    ...
    public Map<String,Object> searchForField (Map<String, Object> params) throws ResponseStatusException{
        ...
        if ( params.get("search") != null && params.get("fields") != null) {
            ...
            PageSearchDTO<OrganicReagent> searchedPage = genericSearch.paginatedGenericSearch(OrganicReagent.class, searchedText, fieldsToSearch, offset, size);
