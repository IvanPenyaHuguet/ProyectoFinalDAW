...
/* harmony import */ var _service_backend_SearchService__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../service/backend/SearchService */ "./src/main/js/service/backend/SearchService.js");
  ...
  var fetchData = (0,react__WEBPACK_IMPORTED_MODULE_12__.useCallback)(function (pageindex, pagesize, textToSearch, elementsToSearch, sortBy, filter) {
    ...
    if (fetchId === fetchIdRef.current) {
      ...
      if (elementsChanged || pageChanged && previousStates.current.previous == 'E') {
        ...
        _service_backend_SearchService__WEBPACK_IMPORTED_MODULE_19__.default.searchReagentByElements(pageindex, pagesize, elementsToSearch).then(function (res) {
        ...
        _service_backend_SearchService__WEBPACK_IMPORTED_MODULE_19__.default.searchReagentPage(pageindex, pagesize, textToSearch, _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_10___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_11___default()(fieldsToSearch).call(fieldsToSearch, function (_ref) {
