...
import BackendService from '../../service/backend/OrganicReagentService';
...
import SearchService from '../../service/backend/Search/OrganicSearchService';
...
import { RTCSearchFields, RTCColumns } from '../../lib/tabledata/OrganicTableConf';
...
const ReagentTable = () => {
    ...
    const TITLE = t('table.title.reagents.organic');
    ...
    return (
        <>   
            <TableContext.Provider value={"OrganicReagent"}>
