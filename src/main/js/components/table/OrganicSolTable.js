...
import BackendService from '../../service/backend/Services/OrganicSolService';
...
import SearchService from '../../service/backend/Search/OrganicSolSearchService';
...
import { RTCSearchFields, RTCColumns } from '../../lib/tabledata/OrganicSolConf';
...
const ReagentTable = () => {
    ...
    const TITLE = t('table.title.reagents.organicsol');
    ...
    const speedDial = useMemo ( () => {
        const actions = [        ,
            ...
            { icon: <ExcelIcon />, name: t('table.tooltip.excel'), click: () => reagentPDF.generateExcel("Organic Standard Solution") },
    ...
    return (
        <>   
            <TableContext.Provider value={"OrganicSol"}>
